<template>
		<view class="cont"   v-if="show">
			...
			<view class="showMessage" :style="{color:acColor}">
				{{message}}
			</view>
		</view>
		...
		methods: {
			random() {
				...
				this.sleft = this.sleftDefault = Math.floor(70 * ram) + 10;
                 if(Math.floor(imgLegth*ram)==6){
					 this.src=`../../static/images/puzzlebg6.png`;
				 }else{
					 this.src=`../../static/images/puzzlebg${Math.floor(imgLegth*ram)+1}.png`;
				 }
	...
	@mixin flexC {
		...
		.cont {
            ...
            .shuaxin{
				...
				width: 40rpx;
				height: 40rpx;
				background: url(../../static/icon/shuaxin.png)no-repeat;
